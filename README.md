...
[![Entries](https://img.shields.io/github/directory-file-count/olitreadwell/remote-job-sites/data/entries?type=file&extension=yaml&label=entries&color=brightgreen)](GUIDE.md)
[![CI](https://github.com/olitreadwell/remote-job-sites/actions/workflows/ci.yml/badge.svg)](https://github.com/olitreadwell/remote-job-sites/actions/workflows/ci.yml)
[![Link check](https://github.com/olitreadwell/remote-job-sites/actions/workflows/linkcheck.yml/badge.svg)](https://github.com/olitreadwell/remote-job-sites/actions/workflows/linkcheck.yml)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)

A living, link-checked directory of remote job search sites, consolidated and deduplicated from popular community lists.

## What this is

A living, link-checked directory of remote job search sites: job boards, aggregators, company career pages, and ATS portals. Every entry is a small YAML
